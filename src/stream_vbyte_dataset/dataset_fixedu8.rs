...
use crate::{
    ...
    stream_vbyte_dataset::stream_vbyte_fixedu8::StreamVbyteFixedu8,
...
pub struct SparseDatasetStreamVbyteFixedu8 {
    dim: usize,
    nnz: usize,
    offsets: Box<[usize]>,
...
impl SparseDatasetStreamVbyteFixedu8 {
    unsafe fn get_stream_vbyte_from_offset(
        &'_ self,
        offset: usize,
        len: usize,
    ) -> StreamVbyteFixedu8<'_> {
        unsafe {
            let view = self.postings.get_unchecked(offset..);
            StreamVbyteFixedu8::from_unchecked(view, len)
        }
    }
}

impl SparseDatasetTrait for SparseDatasetStreamVbyteFixedu8 {
    type Component = u16;
    type Value = FixedU8Q;
    ...
    fn get_with_offset_iter(
        ...
        let stream_view: StreamVbyteFixedu8<'_> =
...
impl<C, O, AC, AV> FromDatasetGenericF32<SparseDatasetGeneric<C, f32, O, AC, AV>>
    for SparseDatasetStreamVbyteFixedu8
where
    ...
    fn from_dataset_f32(dataset: SparseDatasetGeneric<C, f32, O, AC, AV>) -> Self {
        ...
        let offsets = std::iter::once(0)
            .chain(orig_offsets.into_iter().map_windows(|&[start, end]| {
                ...
                StreamVbyteFixedu8::push_posting(&mut postings_u8, c, v);
...
impl SpaceUsage for SparseDatasetStreamVbyteFixedu8 {
...
mod tests {
    ...
    fn conversion_and_dot_product() {
        ...
        let streamed_dataset = SparseDatasetStreamVbyteFixedu8::from_dataset_f32(dataset);
    ...
    fn test_inverted_index() {
        ...
        let inverted_index =
            InvertedIndex::<SparseDatasetStreamVbyteFixedu8>::from_base_dataset(dataset, config);

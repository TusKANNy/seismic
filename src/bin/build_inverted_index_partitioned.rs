...
pub fn main() {
    ...
    let dataset = SparseDatasetMut::<u16, f32>::read_bin_file(&args.input_file.unwrap()).unwrap();
    ...
    println!("Converting to partitioned dataset...");
    let partitioned_dataset =
        SparseDatasetPartitioned::<N_PARTITIONS, u16, FixedU16<U14>>::from_dataset_f32(dataset);

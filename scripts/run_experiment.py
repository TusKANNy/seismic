...
import subprocess
import time
import toml  # Ensure you have the toml package installed
...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment_config_filename", required=True, help="Path to the experiment configuration TOML file.")
    args = parser.parse_args()

    main(args.experiment_config_filename)
